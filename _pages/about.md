...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">NeurIPS 2025</div><img src='images/tool.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[**NeurIPS 2025**] [FlagEval Findings Report: A Preliminary Evaluation of Large Reasoning Models on Automatically Verifiable Textual and Visual Questions](https://arxiv.org/abs/2509.17177)
B Qin, C Yue, F Yin, H Wang, JG Yao, J Liu, JS Zheng, MH Chen, R Xuan, ... 2025.

</div></div>

<div class='paper-box'><div class='paper-box-text' markdown="1">

[**ACL 2025**] [FlagEvalMM: A flexible framework for comprehensive multimodal model evaluation](https://aclanthology.org/...)
Z He, **Yesheng Liu**, J Zheng, X Li, JG Yao, B Qin, R Xuan, X Yang. 2025.

</div></div>

# 📖 Educations
- *2024.09 - Present*, PhD Student, Institute of Automation, CAS (CASIA).
- *2020.09 - 2024.06*, Bachelor, Wuhan University.

<!-- # 💻 Internships
- *2025.03 - 2025.11*, VLM post-training & evaluation, BAAI, Beijing -->